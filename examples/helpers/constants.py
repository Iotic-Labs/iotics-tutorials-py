...
PROPERTY_KEY_ORGANISATION = "https://schema.org/Organization"
...
PROPERTY_VALUE_ORGANISATION_NAME = "https://schema.org/legalName"
...
DELETE_TWIN = RestEndpoint(method="DELETE", url="{host}/qapi/twins/{twin_did}")
DESCRIBE_TWIN = RestEndpoint(method="GET", url="{host}/qapi/twins/{twin_did}")
DESCRIBE_REMOTE_TWIN = RestEndpoint(method="GET", url="{host}/qapi/hosts/{host_id}/twins/{twin_did}")
