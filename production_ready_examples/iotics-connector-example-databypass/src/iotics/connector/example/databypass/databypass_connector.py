...
class DataBypassConnector:
    ...
    def _setup_twin_structure(self) -> TwinStructure:
        ...
        twin_properties = [
            ...
            # ),
            create_property(
                key=constant.PROPERTY_KEY_LABEL, value="Twin Receiver", language="en"
            ),
            create_property(
                key=constant.PROPERTY_KEY_COMMENT,
                value="Twin Receiver that waits for incoming Input messages about DB access",
                language="en",
            ),
            create_property(
        ...
        # db_access_input_properties = [
        #     create_property(
        #         key=constant.PROPERTY_KEY_LABEL, value="DB Access", language="en"
        #     )
        # ]
        # db_access_input_values = []
    ...
    def start(self):
        ...
        # self._wait_for_db_requests()
        
        self._data_processor.get_from_db()
